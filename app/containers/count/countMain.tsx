      ...
      <div className={`text-white text-center p-3 ${classes.content}`}>
        <div className="row">
          <div className={`col-8 ${classes.countAnimate}`}>
            <img src="root://assets/Images/LOGO-CD-161px.png" className={classes.countLogo} style={{transform: `rotate(${-rad}deg)`}}/>


            <div className="text-left">
              <img src={`root://assets/Images/${imgs[which]}.png`} className={`${classes.barImg}`} style={{transform: `translateX(${posX}px) rotate(${rad}deg)`}}/>
            </div>
            <Divider className={`${classes.bgWhite} mt-3`}/>
            <div className="text-left mt-2">
              <img src={`root://assets/Images/10c.png`} className={`${classes.barImg} ml-2`}/>
              <img src={`root://assets/Images/20c.png`} className={`${classes.barImg} ml-2`}/>
              <img src={`root://assets/Images/50c.png`} className={`${classes.barImg} ml-2`}/>
              <img src={`root://assets/Images/1HKD.png`} className={`${classes.barImg} ml-2`}/>
              <img src={`root://assets/Images/2HKD.png`} className={`${classes.barImg} ml-2`}/>
              <img src={`root://assets/Images/5HKD.png`} className={`${classes.barImg} ml-2`}/>
              <img src={`root://assets/Images/10HKD.png`} className={`${classes.barImg} ml-2`}/>
            </div>
          </div>
