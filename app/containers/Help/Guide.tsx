      ...
      <div className={`${classes.bgBlack}`}>
        ...
        <div className={`text-white pl-3 pr-3 m-auto`}>
          <div className={`${classes.content} ${classes.overflow} p-3`}>
            <div className={`border border-white p-3`}>
              ...
              <div className="row">
                <div className="col-3">
                  <img src="root://assets/Images/BADGE-Donation.jpg" className="w-100"></img>
                </div>
                <div className="col-3">
                  <img src="root://assets/Images/BADGE-Octopus.jpg" className="w-100"></img>
                </div>
                <div className="col-3">
                  <img src="root://assets/Images/BADGE-TNG.jpg" className="w-100"></img>
                </div>
                <div className="col-3">
                  <img src="root://assets/Images/BADGE-Bank.jpg" className="w-100"></img>
                </div>
              </div>
            </div>
            ...
            <div className={`border border-white p-3 mt-2`}>
              ...
              <div className="row">
                <div className="col-12">
                  <img src="root://assets/Images/POPOUT-LOADING4C.jpg" className="w-100"></img>
                </div>
              </div>
            </div>
            <div className={`border border-white p-3 mt-2`}>
        ...
        <div className={`text-uppercase ${classes.footer}`}>
          ...
          <Link to={routes.help} className="ml-3">
              <img src='root://assets/Images/icon-back-white.png' className={classes.barImg}></img>
          </Link>
        </div>
      </div>
    </DetectIdle>
